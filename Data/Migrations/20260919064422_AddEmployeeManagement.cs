        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvidentFundPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeBranchAssignments_EmployeeId_BranchId",
                table: "EmployeeBranchAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryPayments_EmployeeId_ForMonth",
                table: "SalaryPayments",
                columns: new[] { "EmployeeId", "ForMonth" },
                unique: true);
