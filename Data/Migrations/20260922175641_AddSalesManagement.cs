        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceKind = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrderLines_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDeliveries_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceDeliveries_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceDeliveries_ServiceOrders_ServiceOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesReturnLines_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderLines_ServiceId",
                table: "SalesOrderLines",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_CompanyId_OrderNo",
                table: "SalesOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesReturnLines_ServiceId",
                table: "SalesReturnLines",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesReturns_CompanyId_ReturnNo",
                table: "SalesReturns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDeliveries_BranchId",
                table: "ServiceDeliveries",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceDeliveries_CompanyId",
                table: "ServiceDeliveries",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceDeliveries_ServiceOrderId",
                table: "ServiceDeliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_CompanyId_OrderNo",
                table: "ServiceOrders",
                columns: new[] { "CompanyId", "OrderNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_CompanyId_Code",
                table: "Services",
