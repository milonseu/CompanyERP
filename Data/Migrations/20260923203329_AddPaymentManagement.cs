        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseEntryId = table.Column<int>(type: "int", nullable: true),
                    SalaryPaymentId = table.Column<int>(type: "int", nullable: true),
                    AssetRegisterId = table.Column<int>(type: "int", nullable: true),
                    SourceModule = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SourceReferenceNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AssetRegisters_AssetRegisterId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_ExpenseEntries_ExpenseEntryId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_SalaryPayments_SalaryPaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashAccounts_CompanyId_AccountCode",
                table: "CashAccounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_AssetRegisterId",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_CompanyId_PaymentNo",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ExpenseEntryId",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_SalaryPaymentId",
                table: "Payments",
