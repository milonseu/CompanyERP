...
{
    /// <inheritdoc />
    public partial class AddAccountingManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    EntryNo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    EntryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AccountingPeriodId = table.Column<int>(type: "int", nullable: true),
                    PeriodKey = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JournalEntryDetails_ChartOfAccounts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntryDetails_JournalEntryId_AccountId",
                table: "JournalEntryDetails",
