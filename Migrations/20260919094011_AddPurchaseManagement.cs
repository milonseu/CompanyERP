        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseQuotations_PurchaseRequests_PurchaseRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_PurchaseQuotations_PurchaseQuotationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierId = table.Column<int>(type: "int", nullable: false),
                    WarehouseId = table.Column<int>(type: "int", nullable: false),
                    ReceivingNo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseReceivings_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchaseReceivings_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseReceivingLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseReceivingLines_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseReceivingLines_PurchaseReceivings_PurchaseReceivingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_CompanyId_OrderNo",
                table: "PurchaseOrders",
                columns: new[] { "CompanyId", "OrderNo" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_PurchaseQuotationId",
                table: "PurchaseOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseQuotationLines_PurchaseQuotationId",
                table: "PurchaseQuotationLines",
                column: "PurchaseQuotationId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseQuotations_CompanyId_QuotationNo",
                table: "PurchaseQuotations",
                columns: new[] { "CompanyId", "QuotationNo" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseQuotations_PurchaseRequestId",
                table: "PurchaseQuotations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceivingLines_ProductId",
                table: "PurchaseReceivingLines",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceivingLines_PurchaseReceivingId",
                table: "PurchaseReceivingLines",
                column: "PurchaseReceivingId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceivings_BranchId",
                table: "PurchaseReceivings",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceivings_CompanyId_ReceivingNo",
                table: "PurchaseReceivings",
                columns: new[] { "CompanyId", "ReceivingNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_CompanyId_RequestNo",
                table: "PurchaseRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturns_CompanyId_ReturnNo",
                table: "PurchaseReturns",
                columns: new[] { "CompanyId", "ReturnNo" },
                unique: true);
